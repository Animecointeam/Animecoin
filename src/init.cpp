...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to animecoind / RPC client
            std::string strUsage = _("Animecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  animecoind [options]                     " + "\n" +
                  "  animecoind [options] <command> [params]  " + _("Send command to -server or animecoind") + "\n" +
                  "  animecoind [options] help                " + _("List commands") + "\n" +
                  "  animecoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "animecoin:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect animecoind signal handlers
    noui_connect();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: animecoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: animecoind.pid)") + "\n" +
	...
	"  -churn=<n>             " + _("Inbound peers connections disconnect after 10 minutes.") + "\n" +
        ...
        "\n" + _("SSL options: (see the Animecoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Animecoin is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Animecoin version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
