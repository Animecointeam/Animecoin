...
static const int64 MAX_MONEY = 2500000000 * COIN; // ~2.000 billion + ~8 million pa (inflation) 
...
public:
    ...
    */
    ...
    int64_t GetMinFee(unsigned int nBytes, bool fAllowFree, enum GetMinFee_mode mode) const;
