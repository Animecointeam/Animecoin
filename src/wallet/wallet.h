...
public:
     ...
     */
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlySafe=true, const CCoinControl *coinControl = nullptr, bool fIncludeZeroValue=false) const;
    ...
    std::map<CTxDestination, CAmount> GetWatchOnlyBalances();
