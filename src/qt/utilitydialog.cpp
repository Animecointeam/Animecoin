// Copyright (c) 2011-2014 The Animecoin developers
...
void PaperWalletDialog::on_getNewAddress_clicked()
{
    ...
    double maxTextWidth = paperHeight * 0.65;
    double minTextWidth = paperHeight * 0.64;
    int pixelSizeStep = 1;
...
void PaperWalletDialog::on_printButton_clicked()
{
    ...
    int walletsPerPage = 2;

    int pageHeight = printer.pageLayout().paintRectPixels(printer.resolution()).height() - PAPER_WALLET_PAGE_MARGIN;
    int pageWidth = printer.pageLayout().paintRectPixels(printer.resolution()).width() - PAPER_WALLET_PAGE_MARGIN;
