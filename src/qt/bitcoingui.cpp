...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an Animecoin address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Animecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Animecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Animecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a anime: URI"));
    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Animecoin help message to get a list with possible command-line options"));
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        setNumBlocks(_clientModel->getNumBlocks(), clientModel->getLastBlockDate(), clientModel->getVerificationProgress(nullptr), false);
        ...
        connect(_clientModel, SIGNAL(auxiliaryBlockRequestProgressChanged(QDateTime,int,int)), this, SLOT(setAuxiliaryBlockRequestProgress(QDateTime,int,int)));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Animecoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        connectionsControl->setToolTip(tr("%n active connection(s) to Animecoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Animecoin"); // default title
    ...
    menu(0)
{
    ...
    setStyleSheet(QString("QLabel { color : %1 }").arg(QColor(0,0,0).name())); // Perhaps SingleColor()
}
