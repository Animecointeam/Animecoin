    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Animecoin");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin and Anime developers"));
...
{
    wallet->ShowProgress.connect(boost::bind(ShowProgress, splash, _1, _2, false));
}
#endif
...
#ifdef ENABLE_WALLET
    if(pwalletMain)
        pwalletMain->ShowProgress.disconnect(boost::bind(ShowProgress, this, _1, _2, false));
#endif
}
