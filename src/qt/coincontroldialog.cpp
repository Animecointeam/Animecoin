...
QString CoinControlDialog::getPriorityLabel(double dPriority)
{
    if (CTransaction::AllowFree(dPriority)) // at least medium
    {
        ...
        else if (CTransaction::CTransaction::AllowFree(dPriority / 100000))   return tr("higher");
...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    if (nQuantity > 0)
    {
        ...
        // Min Fee
        int64_t nMinFee = txDummy.GetMinFee(nBytes, CTransaction::AllowFree(dPriority), GMF_SEND);
