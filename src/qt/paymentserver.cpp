...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click anime: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start anime: click-to-pay handler");
    else
...
{
    // clicking on anime: URLs creates FileOpen events on the Mac:
