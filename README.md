Animecoin 0.10.2 beta
====================
![Animecoin](https://pool.animeco.in/coin-ANI.png)
...
- No premine.
- SPV mode out of the box.
- Multisig tools out of the box.
...
Downgrading
---------------------
0.10.2 beta brings CSV and SegWit update to the network, which is active since Nov 2025. This is the supported version now, update your wallets accordingly.
...
0.10.2 pre-release notes
---------------------
- Vbits softfork system is now active, starting with CSV and SegWit.
- Wallet tools for multisig operations, including escrow contracts and HTLC.
- GUI support for monitoring non-owned addresses, including contract ones.
- Free transactions removed, all transactions require a proportional fee now.
...
Copyright (c) 2014-2025 Animecoin Developers
